...
public class IndexerRollersIOTalonFX implements IndexerRollersIO {
  private final TalonFX motor = new TalonFX(IndexerConstants.IndexerRollers.CAN_ID);
  ...
  public IndexerRollersIOTalonFX() {
    config.CurrentLimits.SupplyCurrentLimit = IndexerConstants.IndexerRollers.CURRENT_LIMIT;
    config.CurrentLimits.SupplyCurrentLimitEnable =
        IndexerConstants.IndexerRollers.CURRENT_LIMIT_ENABLE;
    config.MotorOutput.NeutralMode = IndexerConstants.IndexerRollers.NEUTRAL_MODE;
    config.MotorOutput.Inverted = IndexerConstants.IndexerRollers.INVERTED;

    config.Slot0.kI = IndexerConstants.IndexerRollers.Gains.kI;
    config.Slot0.kP = IndexerConstants.IndexerRollers.Gains.kP;
    config.Slot0.kD = IndexerConstants.IndexerRollers.Gains.kD;
    config.Slot0.kA = IndexerConstants.IndexerRollers.Gains.kA;
    config.Slot0.kV = IndexerConstants.IndexerRollers.Gains.kV;
    config.Slot0.kS = IndexerConstants.IndexerRollers.Gains.kS;
  ...
  @Override
  public void updateInputs(IndexerRollersIOInputs inputs) {
